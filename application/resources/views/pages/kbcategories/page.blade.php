        ...
        <div class="row p-t-10" id="knowledgebase-search-field">
            <div class="col-lg-12">
                ...
                <div class="text-center p-t-5 p-b-40 m-b-30">
                    <h5 class="display-inline-block">{{ cleanLang(__('lang.get_help_from_knowledgebase')) }}</h5> <h5 class="display-inline-block"><a href="{{ url('') }}/tickets/create">You can also open a support ticket</a></h5>
                </div>
