<head>
    ...
    <script src="grow_crm/public/vendor/js/vendor.header.js?v={{ config('system.versioning') }}"></script>
    ...
    <!--VENDORS CSS-->
    <link rel="stylesheet" href="grow_crm/public/vendor/css/vendor.css?v={{ config('system.versioning') }}">

    <!--ICONS-->
    <link rel="stylesheet" href="grow_crm/public/vendor/fonts/growcrm-icons/styles.css?v={{ config('system.versioning') }}">

    <!--THEME STYLE-->
    @if(auth()->check())
    <link
        href="grow_crm/public/themes/{{ auth()->user()->pref_theme }}/css/style.css?v={{ config('system.settings_system_javascript_versioning') }}"
        rel="stylesheet">
    @else
        <link href="{{ 'grow_crm/'.config('theme.selected_theme_css') }} " rel="stylesheet">
    @endif

    <!--USERS CUSTON CSS FILE-->
    <link href="grow_crm/public/css/custom.css?v={{ config('system.versioning') }}" rel="stylesheet">
    ...
    <!--boot js-->
    <script src="grow_crm/public/js/core/head.js?v={{ config('system.versioning') }}"></script>
