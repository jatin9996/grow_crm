...
<tr id="invoice_{{ $invoice->bill_invoiceid  }}">
    ...
    <td class="invoices_col_company" id="invoices_col_company_{{ $invoice->bill_invoiceid }}">
        <a href="{{ url('') }}/clients/{{ $invoice->bill_clientid }}">{{ str_limit($invoice->client_company_name ?? '---', 12) }}</a>
    </td>
    @endif
    @if(config('visibility.invoices_col_project'))
    <td class="invoices_col_project" id="invoices_col_project_{{ $invoice->bill_invoiceid }}">
        <a href="{{ url('') }}/projects/{{ $invoice->bill_projectid }}">{{ str_limit($invoice->project_title ?? '---', 12) }}</a>
    </td>
    @endif
    ...
    <td class="invoices_col_action actions_column" id="invoices_col_action_{{ $invoice->bill_invoiceid }}">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <a href="{{ url('') }}/invoices/{{ $invoice->bill_invoiceid }}/edit-invoice" title="{{ cleanLang(__('lang.edit')) }}"
                class="data-toggle-action-tooltip btn btn-outline-info btn-circle btn-sm">
                <i class="sl-icon-note"></i>
            </a>
            @endif
            <a href="{{ url('') }}/invoices/{{ $invoice->bill_invoiceid }}" title="{{ cleanLang(__('lang.view')) }}"
                class="data-toggle-action-tooltip btn btn-outline-info btn-circle btn-sm">
