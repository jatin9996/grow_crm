<head>
    ...
    <script src="grow_crm/public/vendor/js/vendor-lite.header.js?v={{ config('system.versioning') }}"></script>
    ...
    <!--VENDORS CSS-->
    <link rel="stylesheet" href="grow_crm/public/vendor/css/vendor-lite.css?v={{ config('system.versioning') }}">
