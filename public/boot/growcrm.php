...
//page
$page = '
<!DOCTYPE html><html lang="en" class="team"><head><link href="grow_crm/public/vendor/css/bootstrap/bootstrap.min.css" rel="stylesheet"><link href="grow_crm/public/themes/default/css/style.css" rel="stylesheet"><link rel="stylesheet" href="grow_crm/public/vendor/css/vendor.css"></head>
...
<h5>System Check</h5><div><img src="grow_crm/public/images/system-checks.png" width="300" alt="system checks failed" /></div><p class="card-text">The following (minimum system requirements) must be met before you can continue. See <a href="https://growcrm.io/documentation/2-installation/" target="_blank">documentation</a> for details.</p>
