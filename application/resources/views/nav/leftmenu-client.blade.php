        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                title="{{ cleanLang(__('lang.invoices')) }}">
                    <a class="waves-effect waves-dark" href="{{ url('') }}/invoices" aria-expanded="false" target="_self">
                ...
                title="{{ cleanLang(__('lang.payments')) }}">
                    <a class="waves-effect waves-dark" href="{{ url('') }}/payments" aria-expanded="false" target="_self">
                ...
                <li class="sidenav-menu-item {{ $page['mainmenu_subscription'] ?? '' }} menu-tooltip menu-with-tooltip"
                    ...
                    <a class="waves-effect waves-dark p-r-20" href="{{ url('') }}/subscriptions" aria-expanded="false"
                        target="_self">
                ...
                title="{{ cleanLang(__('lang.estimates')) }}">
                    <a class="waves-effect waves-dark" href="{{ url('') }}/estimates" aria-expanded="false" target="_self">
                ...
                title="{{ cleanLang(__('lang.knowledgebase')) }}">
                    <a class="waves-effect waves-dark p-r-20" href="{{ url('') }}/knowledgebase" aria-expanded="false" target="_self"
                        >
