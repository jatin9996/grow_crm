...
<div class="col-sm-12 col-md-4 col-lg-3" id="category_<?php echo e($category->kbcategory_id ?? ''); ?>">
    <div class="card kb-category">
        <div class="card-body">
            ...
            <a href="<?php echo e(url('')); ?>/kb/articles/<?php echo e($category->kbcategory_slug); ?>" class="btn btn-sm btn-rounded-x btn-outline-info"><?php echo e(cleanLang(__('lang.see_articles'))); ?></a>
        </div>
    </div>
</div>
<!--each category-->
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\grow_crm\application\resources\views/pages/kbcategories/components/list/ajax.blade.php ENDPATH**/ ?>