...
<aside class="left-sidebar" id="js-trigger-nav-team">
        ...
        <nav class="sidebar-nav" id="main-sidenav">
            <ul id="sidebarnav">
                ...
                <li class="sidenav-menu-item <?php echo e($page['mainmenu_kb'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    ...
                    <a class="waves-effect waves-dark p-r-20" href="<?php echo e(url('')); ?>/notes" aria-expanded="false"
                        target="_self">
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/disrtinfotech/public_html/grow_crm/application/resources/views/nav/leftmenu-team.blade.php ENDPATH**/ ?>