    ...
    <div class="card-body">
        ...
        <div class="x-section">
            ...
            <ul>
                ...
                <li><a href="{{ url('') }}/kb/articles/{{ $category->kbcategory_slug }}"">{{ $category->kbcategory_title }}</a></li>
                @endforeach
            </ul>
        </div>
        ...
        <div class="x-section">
            ...
            <a href="{{ url('') }}/tickets/create" class="btn btn-sm btn-rounded-x btn-danger edit-add-modal-button">{{ cleanLang(__('lang.open_a_support_ticket')) }}</a>
        </div>
        @endif
    </div>
