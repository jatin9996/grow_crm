...
<tr id="client_<?php echo e($client->client_id); ?>">
    ...
    <td class="clients_col_company" id="clients_col_id_<?php echo e($client->client_id); ?>">
        <a href="<?php echo e(url('')); ?>/clients/<?php echo e($client->client_id ?? ''); ?>"><?php echo e(str_limit($client->client_company_name, 35)); ?></a>
    </td>
    ...
    <td class="clients_col_action actions_column" id="clients_col_action_<?php echo e($client->client_id); ?>">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <a href="<?php echo e(url('')); ?>/clients/<?php echo e($client->client_id ?? ''); ?>" class="btn btn-outline-info btn-circle btn-sm">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/disrtinfotech/public_html/grow_crm/application/resources/views/pages/clients/components/table/ajax.blade.php ENDPATH**/ ?>