    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-collapse header-overlay" id="main-top-nav-bar">
            ...
            <ul class="navbar-nav navbar-top-right my-lg-0" id="right-topnav-navbar">
                ...
                <li class="nav-item dropdown <?php echo e(request('user_has_due_reminder')); ?>" id="topnav-reminders-dropdown"
...
</header><?php /**PATH /home/disrtinfotech/public_html/grow_crm/application/resources/views/nav/topnav.blade.php ENDPATH**/ ?>