...
<aside class="left-sidebar settings-menu">
            ...
            <ul id="sidebarnav">
                ...
                <li class="sidenav-menu-item <?php echo e($page['settingsmenu_main'] ?? ''); ?>">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a href="javascript:void(0);" data-url="/settings/errorlogs" id="settings-menu-main-errorlogs"
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/disrtinfotech/public_html/grow_crm/application/resources/views/pages/settings/leftmenu-settings.blade.php ENDPATH**/ ?>