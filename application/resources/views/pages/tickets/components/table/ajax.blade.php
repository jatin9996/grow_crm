...
<tr id="ticket_{{ $ticket->ticket_id }}">
    ...
    <td class="tickets_col_id"><a href="{{ url('') }}/tickets/{{ $ticket->ticket_id }}">{{ $ticket->ticket_id }}</a></td>
    @endif
    <td class="tickets_col_subject">
        <a href="{{ url('') }}/tickets/{{ $ticket->ticket_id }}">{{ str_limit($ticket->ticket_subject ?? '---', 35) }}</a>
    </td>
    ...
    <td class="tickets_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            @endif
            <a href="{{ url('') }}/tickets/{{ $ticket->ticket_id }}" title="{{ cleanLang(__('lang.view')) }}"
